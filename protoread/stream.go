...
func (rs *reflStream) listServices(ctx context.Context) (*grpc_reflection_v1.ListServiceResponse, error) {
...
func (rs *reflStream) fileContainingSymbol(ctx context.Context, symbol string) (*grpc_reflection_v1.FileDescriptorResponse, error) {
	d, err := rs.roundTrip(&grpc_reflection_v1.ServerReflectionRequest{
...
func (rs *reflStream) file(ctx context.Context, path string) (*grpc_reflection_v1.FileDescriptorResponse, error) {
	d, err := rs.roundTrip(&grpc_reflection_v1.ServerReflectionRequest{
