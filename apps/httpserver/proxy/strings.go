...
type decoder interface {
	JSONToProto([]byte, protoreflect.Message) error
}

func setFieldFromString(codec decoder, inputMessage protoreflect.Message, fd protoreflect.FieldDescriptor, provided string) error {
...
func setFieldFromStrings(codec decoder, inputMessage protoreflect.Message, key string, provided []string) error {
